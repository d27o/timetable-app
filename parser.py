...
def get_timetable_by_group(group):
    ...
    for col in range(max_cols):
        ...
        if cell_value != '' and group in cell_value:
            lessonStr_1_1 = f"| {sheet.cell(3, col).value} {sheet.cell(3, col+1).value} {sheet.cell(3, col+2).value} {sheet.cell(3, col+3).value} \n|| {sheet.cell(4, col).value} {sheet.cell(4, col+1).value} {sheet.cell(4, col+2).value} {sheet.cell(4, col+3).value}" 
            lessonStr_1_2 = f"| {sheet.cell(5, col).value} {sheet.cell(5, col+1).value} {sheet.cell(5, col+2).value} {sheet.cell(5, col+3).value} \n|| {sheet.cell(6, col).value} {sheet.cell(6, col+1).value} {sheet.cell(6, col+2).value} {sheet.cell(6, col+3).value}" 
            lessonStr_1_3 = f"| {sheet.cell(7, col).value} {sheet.cell(7, col+1).value} {sheet.cell(7, col+2).value} {sheet.cell(7, col+3).value} \n|| {sheet.cell(8, col).value} {sheet.cell(8, col+1).value} {sheet.cell(8, col+2).value} {sheet.cell(8, col+3).value}" 
            lessonStr_1_4 = f"| {sheet.cell(9, col).value} {sheet.cell(9, col+1).value} {sheet.cell(9, col+2).value} {sheet.cell(9, col+3).value} \n|| {sheet.cell(10, col).value} {sheet.cell(10, col+1).value} {sheet.cell(10, col+2).value} {sheet.cell(10, col+3).value}" 
            lessonStr_1_5 = f"| {sheet.cell(11, col).value} {sheet.cell(11, col+1).value} {sheet.cell(11, col+2).value} {sheet.cell(11, col+3).value} \n|| {sheet.cell(12, col).value} {sheet.cell(12, col+1).value} {sheet.cell(12, col+2).value} {sheet.cell(12, col+3).value}" 
            lessonStr_1_6 = f"| {sheet.cell(13, col).value} {sheet.cell(13, col+1).value} {sheet.cell(13, col+2).value} {sheet.cell(13, col+3).value} \n|| {sheet.cell(14, col).value} {sheet.cell(14, col+1).value} {sheet.cell(14, col+2).value} {sheet.cell(14, col+3).value}" 
...
arr = get_timetable_by_group('ББСО-02-17')
